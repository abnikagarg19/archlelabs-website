...
Positioned.fill(child: Container(color: const Color.fromARGB(167, 6, 6, 6))),
          Center(
            child: Container(
                        ...
                        child: Container(
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 30,),
                              Text(
                                " This realization underscored the need for technology-driven solutions that extend beyond patient care to also empower caregivers. Now in the product development phase, the company is evolving with a dedicated core-team  committed to pioneering healthcare solutions. Attracting investor interest and strategic partnerships, it remains focused on refining innovations, expanding collaborations, and securing resources for full-scale implementation.",
                                style: GoogleFonts.openSans(
                                    color: const Color.fromARGB(255, 255, 255, 255),
                                    fontSize: Constant.TextSize20(context),
                                    height: 2.5),
                      ...
                      Expanded(
                        child: Container(
                          child: Column(
                            children: [
                              Text(
                                "What began as a spark of empathy is steadily transforming into a force for change, driven by a resolute commitment to making superior medical care accessible to all.With an initial focus on remote elderly care, the venture gained momentum through the belief and guidance of a mentor-investor, whose untimely passing became a defining moment—transforming a promising idea into an unshakable mission to revolutionize healthcare accessibility. ",
                                style: GoogleFonts.openSans(
                                    color: const Color.fromARGB(255, 255, 255, 255),
                                    fontSize: Constant.TextSize20(context),
                                    height: 2.5),
